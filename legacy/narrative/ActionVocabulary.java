...
public final class ActionVocabulary {
    ...
    public enum ActionType {
        /** Entity placed on a list. */
        ADDITION,
        /** Entity taken off a list. */
        REMOVAL,
        /** Entry changed but still in force. */
        AMENDMENT,
        /** Regulator caution, not a designation. Never affects status. */
        WARNING,
        /**
         * A general licence: permission to transact DESPITE a designation.
         *
         * Not an addition and not a removal. Its presence is positive evidence
         * the entity IS designated -- a licence is only needed against a live
         * listing -- so StatusDeriver treats it as a LIVE signal but never as a
         * lifecycle event. Classifying it either way would be wrong in opposite
         * directions.
         */
        AUTHORISATION,
        /** Recognised shape, unrecognised verb. Quarantined for review. */
        UNCLASSIFIED
    }
